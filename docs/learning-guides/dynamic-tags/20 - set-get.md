...
- [JS](#js-variable)
- [List](/docs/learning-guides/dynamic-tags/list#get-list)
- [Local](#local-variable)
- [Logic](/docs/learning-guides/dynamic-tags/if/logic-variables#get-condition)
- [Loop](/docs/learning-guides/dynamic-tags/Loop/features/variables)
- [Map](/docs/learning-guides/dynamic-tags/map#get-map)
- [Path](/docs/learning-guides/dynamic-tags/path)
- [Query](/docs/learning-guides/dynamic-tags/Loop/features/variables#query-variable-type)
- [Route](/docs/learning-guides/dynamic-tags/route)
- [Sass](#sass-variable)
- [Setting](/docs/learning-guides/dynamic-tags/setting)
- [Site](/docs/learning-guides/dynamic-tags/site)
- [Template](#template-variable)
- [URL](/docs/learning-guides/dynamic-tags/url)
